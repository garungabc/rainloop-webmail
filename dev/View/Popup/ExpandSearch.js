...
@popup({
	name: 'View/Popup/ExpandSearch',
	templateID: 'PopupsExpandSearch'
})
class ExpandSearchPopupView extends AbstractViewNext
{
	constructor() {
		super();
...
export {ExpandSearchPopupView, ExpandSearchPopupView as default};
